# alinesno-smart-model-adapter ChangeLog
...
- refactor: optimize alinesno-smart-model-adapter-solon-plugin @noear_admin

---
- 优化：重构 llm api
- 优化：重构 chain 链路 及其相关节点
- 优化：优化 alinesno-smart-model-adapter-solon-plugin @noear_admin
...
- refactor: update pom.xml in alinesno-smart-model-adapter-bom
...
- 优化：更新 alinesno-smart-model-adapter-bom 的 pom.xml
...
- feat: add custom request header in openaiLLM https://github.com/alinesno-smart-model-adapter/alinesno-smart-model-adapter/issues/5
- feat: add https.proxyHost config for the http client, close https://github.com/alinesno-smart-model-adapter/alinesno-smart-model-adapter/issues/1
...
---
- 新增: 添加自定义 openaiLLM 请求 api 的支持  https://github.com/alinesno-smart-model-adapter/alinesno-smart-model-adapter/issues/5
- 新增: 添加 https.proxyHost 配置的支持 https://github.com/alinesno-smart-model-adapter/alinesno-smart-model-adapter/issues/1
