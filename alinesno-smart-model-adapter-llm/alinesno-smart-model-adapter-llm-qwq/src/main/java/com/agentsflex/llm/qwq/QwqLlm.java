...
public class QwqLlm extends BaseLlm<QwqLlmConfig> {


    HttpClient httpClient = new HttpClient();

    public AiMessageParser aiMessageParser = QwqLlmUtil.getAiMessageParser(false);
    public AiMessageParser streamMessageParser = QwqLlmUtil.getAiMessageParser(true);


    public QwqLlm(QwqLlmConfig config) {
        super(config);
    }
    ...
    public AiMessageResponse chat(Prompt prompt, ChatOptions options) {
        ...
        String payload = QwqLlmUtil.promptToPayload(prompt, config, options, false);
    ...
    public void chatStream(Prompt prompt, StreamResponseListener listener, ChatOptions options) {
        ...
        String payload = QwqLlmUtil.promptToPayload(prompt, config, options, true);
    ...
    public VectorData embed(Document document, EmbeddingOptions options) {
        String payload = QwqLlmUtil.promptToEnabledPayload(document, options, config);
        Map<String, String> headers = new HashMap<>();
        headers.put("Content-Type", "application/json");
        headers.put("Authorization", "Bearer " + getConfig().getApiKey());
