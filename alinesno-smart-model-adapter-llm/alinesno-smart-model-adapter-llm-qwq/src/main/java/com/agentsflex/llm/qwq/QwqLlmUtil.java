...
public class QwqLlmUtil {
    ...
    public static String promptToPayload(Prompt prompt, QwqLlmConfig config, ChatOptions options, boolean withStream) {
    ...
    public static String promptToEnabledPayload(Document text, EmbeddingOptions options, QwqLlmConfig config) {
