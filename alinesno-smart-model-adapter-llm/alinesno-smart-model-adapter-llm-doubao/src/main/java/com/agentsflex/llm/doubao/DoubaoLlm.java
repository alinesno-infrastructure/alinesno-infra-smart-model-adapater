...
public class DoubaoLlm extends BaseLlm<DoubaoLlmConfig> {


    HttpClient httpClient = new HttpClient();

    public AiMessageParser aiMessageParser = DoubaoLlmUtil.getAiMessageParser(false);
    public AiMessageParser streamMessageParser = DoubaoLlmUtil.getAiMessageParser(true);


    public DoubaoLlm(DoubaoLlmConfig config) {
        super(config);
    }
    ...
    public AiMessageResponse chat(Prompt prompt, ChatOptions options) {
        ...
        String payload = DoubaoLlmUtil.promptToPayload(prompt, config, options, false);
    ...
    public void chatStream(Prompt prompt, StreamResponseListener listener, ChatOptions options) {
        ...
        String payload = DoubaoLlmUtil.promptToPayload(prompt, config, options, true);
    ...
    public VectorData embed(Document document, EmbeddingOptions options) {
        String payload = DoubaoLlmUtil.promptToEnabledPayload(document, options, config);
        Map<String, String> headers = new HashMap<>();
        headers.put("Content-Type", "application/json");
        headers.put("Authorization", "Bearer " + getConfig().getApiKey());
