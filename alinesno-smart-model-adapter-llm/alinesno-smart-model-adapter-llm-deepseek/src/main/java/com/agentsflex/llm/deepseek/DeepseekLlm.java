...
public class DeepseekLlm extends BaseLlm<DeepseekLlmConfig> {
    ...
    public AiMessageParser aiMessageParser = DeepseekLlmUtil.getAiMessageParser(false);
    public AiMessageParser streamMessageParser = DeepseekLlmUtil.getAiMessageParser(true);
    ...
    public VectorData embed(Document document, EmbeddingOptions options) {
        String payload = DeepseekLlmUtil.promptToEnabledPayload(document, options, config);
        Map<String, String> headers = new HashMap<>();
        headers.put("Content-Type", "application/json");
        headers.put("Authorization", "Bearer " + getConfig().getApiKey());
