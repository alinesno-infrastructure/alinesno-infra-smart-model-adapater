 ...
 */
@Getter
public enum QwenVectorModelEnums {
    ...
    QwenVectorModelEnums(String modelName, String usageScenario, String vectorDimension, boolean isOpenSource) {
    ...
    public static List<Map<String, String>> getAllModels() {
        QwenVectorModelEnums[] values = QwenVectorModelEnums.values();
        List<Map<String, String>> list = new java.util.ArrayList<>();
        for (QwenVectorModelEnums value : values) {
