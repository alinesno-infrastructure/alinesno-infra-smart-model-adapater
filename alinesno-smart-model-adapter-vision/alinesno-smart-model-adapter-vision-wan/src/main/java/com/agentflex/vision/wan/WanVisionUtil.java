 ...
 */
package com.agentflex.vision.wan;
...
public class WanVisionUtil {
    ...
    public static String promptToPayload(Prompt prompt, WanVisionConfig config, ChatOptions options, boolean withStream) {
